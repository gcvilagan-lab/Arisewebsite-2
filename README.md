...
<style>
  :root {
    ...
    --text: #f4f7fc;
    --muted: #8fa0c0;
    --border: rgba(243, 169, 59, 0.15);
    --glow: 0 0 24px rgba(243, 169, 59, 0.3);
  }
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  nav.scrolled { box-shadow: 0 4px 40px rgba(243, 169, 59, 0.1); }
  ...
  .hero-grid {
    ...
    background-image:
      linear-gradient(rgba(243, 169, 59, 0.04) 1px, transparent 1px),
      linear-gradient(90deg, rgba(243, 169, 59, 0.04) 1px, transparent 1px);
  ...
  .hero-glow {
    ...
    background: radial-gradient(circle, rgba(243, 169, 59, 0.06) 0%, transparent 70%);
  ...
  .hero-title .glow-text {
    color: var(--accent);
    text-shadow: 0 0 40px rgba(243, 169, 59, 0.4), 0 0 80px rgba(243, 169, 59, 0.2);
  }
  ...
  .btn-primary {
    background: var(--accent);
    color: var(--bg);
    box-shadow: 0 0 20px rgba(243, 169, 59, 0.3);
  }
  .btn-primary:hover {
    transform: translateY(-3px);
    box-shadow: 0 8px 30px rgba(243, 169, 59, 0.5);
  }
  .btn-outline {
  ...
  .about-box {
    ...
    display: flex; align-items: center; justify-content: center;
    font-size: 2.5rem;
    box-shadow: 0 0 30px rgba(243, 169, 59, 0.03);
  ...
  .robot-visual {
    ...
    position: relative; overflow: hidden;
    font-size: 5rem;
    background: linear-gradient(135deg, rgba(243, 169, 59, 0.05), transparent);
  }
  .robot-visual::before {
    content: '';
    position: absolute; inset: 0;
  ...
  .robot-emoji {
    ...
    filter: drop-shadow(0 0 20px rgba(243, 169, 59, 0.3));
  }
  ...
  .join-glow {
    ...
    background: radial-gradient(ellipse, rgba(243, 169, 59, 0.06) 0%, transparent 70%);
    top: 50%; left: 50%;
